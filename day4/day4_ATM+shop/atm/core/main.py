...
def account_info(acc_data):
    print('\033[31;1m上面是%s的账户信息\033[0m' % acc_data['account_id'])
...
def withdraw(acc_data):
    '''
    print current balance and let user to the withdraw action
    :param acc_data:
    :return:
    '''
    account_data = accounts.load_current_balance(acc_data['account_id'])
    ...
    while not back_flag:
        ...
        if len(withdraw_amount) > 0 and withdraw_amount.isdigit():   # isdigit 判断str是否为纯数字
